...
\centering
	\subfloat[]{
		\includegraphics[width=0.4\textwidth]{damage_low_crop} 
	}
	\subfloat[]{
		\includegraphics[width=0.4\textwidth]{damage_high_crop}
	}
...
% Where were the tissue samples taken from?
% How were the tissue samples taken? How much material?
% 45 phenolic compounds and
% was used to estimate the concentration of phenolics and gas chromatography was used to estimate the concentration of terpenes. 
