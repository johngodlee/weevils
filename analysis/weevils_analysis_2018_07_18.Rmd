...
ggplot() + 
	...
	geom_point(aes(x = dec_longitude, y = dec_latitude, 
								 colour = region, shape = big_region),
						 data = site_loc) + 
	theme_classic() + 
...
```{r}
ggplot(damage, aes(x = population, y = log1p(curr_damage))) + 
	geom_boxplot() + 
	labs(x = "Population",
...
```{r}
ggplot(damage, aes(x = population, y = log1p(prev_damage))) + 
	geom_boxplot() + 
	labs(x = "Population",
...
```{r}
ggplot(damage, aes(x = population, y = log1p(total_damage))) + 
	geom_boxplot() + 
	labs(x = "Population",
...
```{r}
ggplot(damage, aes(x = region_let, y = log1p(curr_damage))) + 
	geom_boxplot() + 
	labs(x = "Population",
			 y = "Total number of lesions") +
	theme_classic()
...
# Using larger population groupings
